 ...
 *  @version 	1.0
 */ 
class Default_Model_PrivateMessages extends Zend_Db_Table_Abstract
{
	// Table name
	...
	protected $_referenceMap    = array(
		...
		'ReceiverUser' => array(
			...
			'refTableClass'		=> array('Default_Model_User'),
			'refColumns'		=> array('id_usr')
		)
    );	
    ...
    public function addMessage($data)
	{
        ...
        if($data['privmsg_sender_id'] == 0)
        {
            $message->message_body_pmg = strip_tags($data['privmsg_message'], "<a>");
        }
        else
        {
