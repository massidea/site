 ...
 *  @version 	1.0
 */ 
class Models_UserGroups extends Zend_Db_Table_Abstract
{
	// Name of table
	...
	protected $_dependentTables = array('Models_ContentHasGroup', 'Models_ContentHasPermission', 'Models_UserHasGroups');

	/*
	protected $_referenceMap    = array(
        'Content' => array(
            'columns'           => array('id_grp'),
            'refTableClass'     => 'Models_ContentHasGroup',
            'refColumns'        => array('id_grp')
        ),
		 'Permission' => array(
            'columns'           => array('id_grp'),
            'refTableClass'     => 'Models_GroupHasPermission',
            'refColumns'        => array('id_grp')
	),
