 ...
 *  @version 	1.0
 */ 
class Models_ContentTypes extends Zend_Db_Table_Abstract
{
	// Table name
	...
	protected $_dependentTables = array('Models_Content');
	...
	*/
	...
	{
		$select = $this->select()->from($this, array('id_cty', 'name_cty', 'key_cty'));
