...
class Oibs_Validators_PasswordConfirmation extends Zend_Validate_Abstract
{
	...
	* 
	* The argument to this constructor is the third argument to the elements' addValidators
	* method. 
	* 
